...
//                 <img src={img} alt='Image1' className='h-40 w-40 p-4 bg-gray-400 rounded-3xl outline-8 outline-double outline-white hover:duration-500 hover:outline-orange-500'></img>
//             </div>
//             <div className='p-2 py-6 box-2 bg-white'>
//                 <h2 className='font-semibold text-xl hover:text-lime-700 cursor-pointer py-4 underline uppercase'>{name}</h2>
//                 <p className='text-sm px-5 text-slate-500'>{disc}</p>
